...
var Callable = function Callable() {
    ...
    function delegate(args) {
        return delegate.invoke.apply(delegate, babelHelpers.toConsumableArray(args));
    }
...
var Property = (function (_Callable) {
    ...
    function Property() {
        ...
        return _ret = (_temp = (_this = babelHelpers.possibleConstructorReturn(this, _Callable.call.apply(_Callable, [this].concat(args))), _this), _this.version = 0, _this.observers = [], _temp), babelHelpers.possibleConstructorReturn(_this, _ret);
    }
